...
console.log("level 2 Presentation Page is Working");
...
const canvas = document.querySelector('.level2_Pre');
...
var BGImg = "../asset/level_two_assets/Backgound.png"
...
// Progress Bar Img Level-1 Complete
...
// var RewardImg = "../asset/logo/Rewards 10.png"
...
// Instructor 
var l2INS1 = "../asset/Instructor_L0_1.png"
var l2INS2 = "../asset/Instructor_L0_2.png"
...
// Slides Images
// Slide 3 Images
// l1PS3 - Level 2 Presentation Slide 3
var l2PS3LHS = "../asset/level_two_assets/image asset Ltwo Updated/Set 9_4 white footballs.png"
var l2PS3RHS = "../asset/level_two_assets/image asset Ltwo Updated/Set 9_5 white footballs.png"

// Slide 6 Images
var l2PS6LHS = "../asset/level_two_assets/image asset Ltwo Updated/Set 1_2 red shirts.png"
var l2PS6RHS = "../asset/level_two_assets/image asset Ltwo Updated/Set 1_10 red shirts.png"
...
// var SXIPosHand = 2.4
// var SYIPosHand = -1.7
var SXIPosHandLHS = -1.2
var SYIPosHandLHS = -1.7
...
// Level 1 All Audios
var Audio1 = '../Sounds/level2_sounds/ML_A_L2_1.mp3'
var Audio2 = '../Sounds/level2_sounds/ML_A_L2_2.mp3'
var Audio3 = '../Sounds/level2_sounds/ML_A_L2_3.mp3'
var Audio4 = '../Sounds/level2_sounds/ML_A_L2_4.mp3'
...
// Slide 5 Variables
var planeS5LHS, planeS5RHS, planeS5Ans;

// Slide 6 Variables
var planeS6LHS, planeS6RHS, planeS6Error, planeS6Success;

// Slide 6 Skip Variables
var planeS6SkipLHS, planeS6SkipRHS, planeSkipBtn;

// INS 1 varibles
var plane, S6Cor = false, Slide6Execute = false, AnsS6Cor = false

var isAudio3Complete = false, isAudio4Complete = false, isAudio4Working = false
...
//Check Image Status
var musicImgStatus = true, isFunc4Active = false, dblClick = false
    ...
    replyAudioSound.source.onended = function () {
      ...
      switch (path) {
        ...
        case CorrectSelSound:
          ...
          // gPlayTshirt()
          if (S6Cor == true) {
            planeS6Success.visible = false
            setTimeout(l2PS6_Skip(), 1000)
          }
...
function replyAudio(path) {
  ...
  loadReplyAudio.load(
    ...
    function (textureReplyAudio) {
      ...
      planeReplyAudio.position.x = 3.36
...
function replayAudioDef() {
  ...
  loadReplyAudio.load(
    ...
    function (textureReplyAudio) {
      ...
      // var planeGeometryReplyAudio = new THREE.PlaneBufferGeometry(0.35, 0.35) // Active
      var planeGeometryReplyAudio = new THREE.PlaneBufferGeometry(0.35, 0.32)
      planeReplyAudio = new THREE.Mesh(planeGeometryReplyAudio, planeMaterialReplyAudio)
      scene.add(planeReplyAudio)
...
function l2PS3() {
  ...
  // Audio Indicating More
  // playAudio("../Sounds/level1_sounds/ML_A_L2_3.mp3")
  playAudio(Audio3)
...
// This Function Football with Hand
function l2PS4() {
  ...
  //  ------------------------  Hand  --------------------------
  // Add Hand Image Here - LHS
  const loadS4Hand = new THREE.TextureLoader();
  loadS4Hand.load(
    // Hand Image
    // "../asset/hand_img.png",
    handImg,
    ...
    function (textureS4Hand) {
      ...
      //Create a 2x2 plane with texture
      var PG_S4Hand = new THREE.PlaneBufferGeometry(1, 1);
      planeS4Hand = new THREE.Mesh(PG_S4Hand, PM_S4Hand);
      scene.add(planeS4Hand);
      // planeintroLessRHSHand.position.x = 2
      // planeintroLessRHSHand.position.y = -1.5
      planeS4Hand.position.x = SXIPosHandLHS
      planeS4Hand.position.y = SYIPosHandLHS
...
// This Function indicate Football success selection
// function introLessSucess(){
function l2PS5() {
  ...
  //  ------------------------  Success Border  --------------------------
  // Load LHS Image Here
  const loadS5Ans = new THREE.TextureLoader();
  loadS5Ans.load(
    ...
    function (textureS5Ans) {
      ...
      //Create a 2x2 plane with texture
      // var PG_S5Ans = new THREE.PlaneBufferGeometry(3, 3);
      var PG_S5Ans = new THREE.PlaneBufferGeometry(WBPosX, WBPosY);
      // console.log("check for plaen size planeGeometryRHS", planeGeometryRHS)
      planeS5Ans = new THREE.Mesh(PG_S5Ans, PM_S5Ans);
      // console.log("planeRHS", planeRHS)
      scene.add(planeS5Ans);
      // planeIntroRHSHighlight.visible = false
      planeS5Ans.position.x = SXIPosLHS
      planeS5Ans.position.y = SYIPosLHS
...
function l2PS6() {
  ...
  if (planeS3LHS.visible) {
    ...
    planeS5Ans.visible = false
    console.log("planeS5Ans false", planeS5Ans.visible)
    // planeintroMoreLHSHand.visible = false
  }
        ...
        domEvents.addEventListener(planeS6LHS, 'click', function (event) {
          if (AnsS6Cor == false) {
            ...
            if (planeGreenStatus == true) {
              ...
              // Load LHS Image Here
              const loadS6AnsLHS = new THREE.TextureLoader();
              loadS6AnsLHS.load(
                // "../asset/level_one_assets/Correct answer highlight.png",
                SuccessBorder,

                function (textureS6Success) {
                  // console.log("LHS Function Executed");
                  var PM_S6Success = new THREE.MeshBasicMaterial({
                    map: textureS6Success,
                    transparent: true,
                    // visible: false 
                  });

                  //Create a 2x2 plane with texture
                  // var PG_S6Success = new THREE.PlaneBufferGeometry(3, 3);
                  var PG_S6Success = new THREE.PlaneBufferGeometry(WBPosX, WBPosY);
                  // console.log("check for plaen size planeGeometryRHS", planeGeometryRHS)
                  planeS6Success = new THREE.Mesh(PG_S6Success, PM_S6Success);
                  // console.log("planeRHS", planeRHS)
                  scene.add(planeS6Success);
                  planeS6Success.position.x = SXIPosLHS
                  planeS6Success.position.y = SYIPosLHS
    ...
    function (textureS6RHS) {
      ...
      domEvents.addEventListener(planeS6RHS, 'click', function (event) {
        ...
        if (planeRedStatus == true) {
          ...
          // Load RHS Image Here
          const loadS6AnsRHS = new THREE.TextureLoader();
          loadS6AnsRHS.load(
            // "../asset/level_one_assets/Incorrect answer highlight.png",
            ErrorBorder,

            function (textureS6Ans) {
              var PM_S6Error = new THREE.MeshBasicMaterial({
                map: textureS6Ans,
                transparent: true,
                // visible: false 
              });
              ...
              //Create a 2x2 plane with texture
              // var PG_S6Error = new THREE.PlaneBufferGeometry(3, 3);
              var PG_S6Error = new THREE.PlaneBufferGeometry(WBPosX, WBPosY);
              // console.log("check for plane size planeGeometryRHS", planeGeometryRHS)
              planeS6Error = new THREE.Mesh(PG_S6Error, PM_S6Error);
              // console.log("planeRHS", planeRHS)
              scene.add(planeS6Error);
              planeS6Error.position.x = SXIPosRHS
              planeS6Error.position.y = SYIPosRHS
...
function l2PS6_Skip() {
  ...
  loadSkipbtn.load(
    ...
    function (textureSkipBtn) {
      ...
      // planeSkipBtn.position.x = 4
      // planeSkipBtn.position.y = -1.4
      // planeSkipBtn.position.z = 1

      // planeSkipBtn.position.x = 3
      // planeSkipBtn.position.y = -1.1
